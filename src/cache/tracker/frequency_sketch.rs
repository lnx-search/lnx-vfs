...
//
// Additional notice:
// The Rust code here has been taken from the https://github.com/moka-rs/moka library
// and this file retains its original Apache & MIT license.
//
// We have made some slight modifications, specifically we use the std library's
// LazyLock instead of `once_cell`.
// These changes are also licensed under the same Apache & MIT license combination as the
// original work.
...
mod tests {
    ...
    static ITEM: LazyLock<u32> = LazyLock::new(|| {
        let mut buf = [0; 4];
